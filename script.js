    ...
    carrinho.forEach((item, index) => {
      ...
      itemElement.innerHTML = `
        ...
        <div class="cart-modal-item-info">
          ...
          <p class="cart-modal-item-price">R$ ${item.preco} ${
...
function carregarProdutosCarrinho() {
  ...
  carrinho.forEach((item, index) => {
    ...
    produtoItem.innerHTML = `
      <img src="${item.imagem_principal}" alt="${item.nome}" class="produto-checkout-img">
      <div class="produto-checkout-info">
        <h5 class="produto-checkout-nome">${item.nome}</h5>
        <p class="produto-checkout-preco">R$ ${item.preco}</p>
